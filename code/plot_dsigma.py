...
if __name__ == '__main__':
   ...
   for i in range(0,4):
       ...
       plt.ylim([.5, 31]) 
   if zpeak == False:    
      title = "Leauthaud+2007, including sources with a secondary photo-z peak"
   elif zpeak == True:
      title = "Leauthaud+2007, excluding sources with a secondary photo-z peak"
   ...
   plt.savefig("/home/vakili/public_html/sheartheta_pau"+str(zpeak)+".png")
   plt.close()
   ...
   plt.savefig("/home/vakili/public_html/redshift_pau"+str(zpeak)+".png")
   plt.close()
